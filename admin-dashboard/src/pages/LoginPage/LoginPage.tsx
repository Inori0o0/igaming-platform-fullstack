  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(ellipse at 20% 50%, rgba(212, 168, 67, 0.06) 0%, transparent 60%), radial-gradient(ellipse at 80% 20%, rgba(212, 168, 67, 0.04) 0%, transparent 50%)",
        }}
      />
      ...
      <div className="relative w-full max-w-sm">
        <div className="flex justify-center mb-3">
          <img
            ...
            style={{
              filter:
                "drop-shadow(0 0 10px rgba(255,255,255,0.9)) drop-shadow(0 0 20px rgba(255,255,255,0.5))",
            }}
          />
        </div>

      ...
      >
        <span
          className={clsx(
            ...
            compact
              ? "max-w-[80%] truncate text-[10px] leading-none sm:text-xs"
            ...
            compact
              ? "filter-[drop-shadow(0_0_1px_rgba(255,255,255,0.95))_drop-shadow(0_0_6px_rgba(34,211,238,0.7))]"
